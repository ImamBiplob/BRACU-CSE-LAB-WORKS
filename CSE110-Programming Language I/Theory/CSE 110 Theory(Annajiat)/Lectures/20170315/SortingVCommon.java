...
public class SortingVCommon { //ascending
      public static void main (String[] args) {
            int count;
            //         0  1  2   3  4
            int[] a = {50,30,10,20,40};
            for(int v=0;v<=a.length-2;++v){
                  int chotoSoFar = a[v];//50
                  int chotoLocation = v;//location of a[0]=50
...
//                  System.out.println(chotoSoFar+" found at "+chotoLocation);
                  int icu = a[v];//backup 50 from a[0] to icu
                  a[v] = chotoSoFar;//copy 50 from chotoSoFar to a[0] replacing 50
