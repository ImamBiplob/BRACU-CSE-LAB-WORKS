...
public class SortingV1 { //ascending
      public static void main (String[] args) {
            int count;
            //         0  1  2   3  4
            int[] a = {50,30,10,20,40};
            int chotoSoFar = a[0];//50
            int chotoLocation = 0;//location of a[0]=50
            ...
            int icu = a[0];//backup 50 from a[0] to icu
            a[0] = chotoSoFar;//copy 50 from chotoSoFar to a[0] replacing 50
