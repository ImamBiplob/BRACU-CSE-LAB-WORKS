...
public class SortingV4 { //ascending
      public static void main (String[] args) {
            int count;
            //         0  1  2   3  4
            int[] a = {10,20,30,50,40};
            int chotoSoFar = a[3];//50
            int chotoLocation =3;//location of a[3]=50
            ...
            int icu = a[3];//backup 50 from a[0] to icu
            a[3] = chotoSoFar;//copy 50 from chotoSoFar to a[0] replacing 50
