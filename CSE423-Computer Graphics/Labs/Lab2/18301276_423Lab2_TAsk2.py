...
def showScreen():
    ...
    # my id =18301276, will draw House
    midPointLine(-50, 25, 50, 25)
    midPointLine(0,75,-50,25)
    midPointLine(0,75,50,25)
    midPointLine(-45,25,-45,-40)
    midPointLine(45,25,45,-40)
    midPointLine(-45,-40,45,-40)
    midPointLine(-10,-10,-10,-40)
    midPointLine(10,-10,10,-40)
    midPointLine(-10,-10,10,-10)
