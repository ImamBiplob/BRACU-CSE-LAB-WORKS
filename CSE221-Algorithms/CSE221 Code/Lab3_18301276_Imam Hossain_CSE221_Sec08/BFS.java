...
public class BFS{
  ...
  public void runBfs(int source){
   ...
   q.add(source);
   System.out.println("\nVertices will be transversed according to this order:\n");
    ...
    System.out.println("\nLevel Array of vertices is :"+Arrays.toString(level));
    System.out.println("\nParent Array of vertices is :"+Arrays.toString(parent));
